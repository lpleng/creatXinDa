<template>
  <div>
    ...
    <Row>
      <Col id="content_left" :xs="24" :sm="0" :md="0">
      <div class="cont_left_box">
        ...
        <div class="yanzheng">
          ...
          <span class="verif1">
            <img :src="imgCodeUrl" alt="点击刷新" @click="change_code">
          </span>
          <br>
        </div>
        <!--短信验证码输入-->
        <div class="yanzheng">
          ...
          <button class="click_gain" @click="clickCode" :disabled="time_count>0" :class="{have_clicked:time_count>=0}">点击获取
            <span v-show="time_count>=0">({{time_count}})</span>
          </button>
          <br>
        </div>
        <!--重置密码-->
        <input type="password" placeholder="设置6-20位含数字、字母密码" class="mobile" v-model="new_pwd">
        <br>
