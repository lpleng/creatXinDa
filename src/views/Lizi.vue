...
<div>
    <div class="example">
        <div class="example_nei">
            <input type="text" v-model="search.key"><button @click="search">搜索</button><br>
            <span></span><input type="text" v-model = 'newPerson.name' placeholder="姓名">
            <span></span><input type="text" v-model = 'newPerson.age' placeholder="年纪">
            <span></span><input type="text" v-model = 'newPerson.sex' placeholder="性别">
